...
def test_release_workflow_attests_built_distributions() -> None:
    ...
    assert 'gh attestation verify "$verify_dir/yui_agent_guard-0.3.10.tar.gz"' in readme
    assert "--source-ref refs/tags/v0.3.10\n)\n```" in readme
    ...
    assert "--source-ref refs/tags/v0.3.10" in readme
