...
def test_changelog_records_latest_release_entry() -> None:
    ...
    assert normalized_unreleased == " ".join(
        [
            ...
            "- Restricted required workflow-command evidence to dedicated direct commands, rejecting same-step control flow, Python user-site/import resolution changes, job-container resolution-sensitive environment changes, and dynamic redirection; generated and self-dogfood policy commands now use dedicated steps.",
